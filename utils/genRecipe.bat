...
set THETARGETINDEXFILE_MD=README.md
%TEXTPAR_PATH% %TEMPLATE_INDEX_FILE_MD%
%GPP_PATH% -O index_tmp.txt output.txt -I"%DIRECTORY%"
type index_tmp.txt >> "%RECIPE_DIRECTORY%/%THETARGETINDEXFILE_MD%"
)
del index_tmp.txt
del output.txt
